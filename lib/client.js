...
function BucketRows({ title, buckets }) {
  ...
  if (buckets.cacheReadTokens !== void 0) rows.push({ name: "\u7F13\u5B58\u547D\u4E2D", value: fmtCount(buckets.cacheReadTokens) });
...
function ModelRows({ models }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "gww_section", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "gww_rows", children: models.map((row) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "gww_row", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "gww_rowValue", children: [
        fmtMoney({ quota: row.quota, display: row.quota === 0 ? 0 : void 0, currency: "CNY" }),
        " \xB7 ",
        fmtCount(row.calls),
        " \u6B21"
      ] })
...
function WalletBody({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "gww_content", ...loading === "dim" ? { "data-loading": "" } : {}, children: [
      ...
      snapshot.rate !== void 0 && (snapshot.rate.rpm !== void 0 || snapshot.rate.tpm !== void 0) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "gww_section", children: [
